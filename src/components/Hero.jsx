...
export default function Hero() {
    ...
    const socialItems = [
        ...
        { id: 'cv', url: '/assets/resume.pdf', label: 'Resume', icon: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></> }
    ];
            ...
            >
                <div style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ marginTop: '1rem', fontSize: '0.95rem', fontStyle: 'italic' }}>
                        PSA: If you enjoy artistic work, bookmark this site. I do stuff pretty frequently :D
                    </p>
                </div>
