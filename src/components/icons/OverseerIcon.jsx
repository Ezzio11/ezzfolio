    ...
    return (
        <div
            ...
            style={{
                ...
                borderRadius: '50%',
                flexShrink: 0,
                // Ensure bg color doesn't hide it?
